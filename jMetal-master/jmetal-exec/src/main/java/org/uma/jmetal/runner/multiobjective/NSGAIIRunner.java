...
import org.uma.jmetal.operator.impl.mutation.Exercise3Mutation;
...
public class NSGAIIRunner extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    //System.out.println(" lala " + algorithm.getResult());
    List<DoubleSolution> population = algorithm.getResult();


    //System.out.println(" lala " + population.get(0).getVariableValue(0) + "     " + population.get(0).getObjective(0));
  ...
  public static void custNSGAIIRunner(int populationSize, int MaxEvaluations, String ex)throws JMetalException, FileNotFoundException {
    ...
    if (ex == "Ex2") {
      ...
      for (int i = 0; i < population.size(); i++) {
        population.get(i).setObjective(0, (population.get(i).getObjective(0) * 20 % 20) );
        population.get(i).setObjective(1, (population.get(i).getObjective(1) * 20 % 20) );
      }
    }else if (ex == "Ex4"){
      for (int i = 0; i < population.size(); i++) {
