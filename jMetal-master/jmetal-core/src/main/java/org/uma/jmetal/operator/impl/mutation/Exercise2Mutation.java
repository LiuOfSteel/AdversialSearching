...
public class Exercise2Mutation implements MutationOperator<DoubleSolution> {
    ...
    /** Constructor */
    public Exercise2Mutation() {
        this(DEFAULT_PROBABILITY, DEFAULT_DISTRIBUTION_INDEX) ;
    }

    /** Constructor */
    public Exercise2Mutation(DoubleProblem problem, double distributionIndex) {
        this(1.0/problem.getNumberOfVariables(), distributionIndex) ;
    }

    /** Constructor */
    public Exercise2Mutation(DoubleProblem problem,
    ...
    /** Constructor */
    public Exercise2Mutation(double mutationProbability, double distributionIndex) {
        this(mutationProbability, distributionIndex, new RepairDoubleSolutionAtBounds()) ;
    }

    /** Constructor */
    public Exercise2Mutation(double mutationProbability,
                              double distributionIndex,
                              RandomGenerator<Double> randomGenerator) {
...
*/
    ...
    private void doMutation(double probability, DoubleSolution solution) {
        ...
        for (int i = 0; i < solution.getNumberOfVariables(); i++) {
            if (Math.random() < 20) {
                 ...
                 */
                DoubleSolution solution2 = (DoubleSolution)solution.copy();
                double pos1 ;
                double pos2 ;
                ...
                solution2.setVariableValue(i, pos1 );
                // System.out.println(solution.getVariableValue(i));
    ...
    private void doIt(double probability, DoubleSolution solution) {
        double rnd, delta1, delta2, mutPow, deltaq;
        double y, yl, yu, val, xy;
        //System.out.println(" in PolynomialMutation solution.getNumberVariables() : " + solution.getNumberOfVariables());
        // System.out.println("solution.getNumberObjectives() : " + solution.getNumberOfObjectives());
